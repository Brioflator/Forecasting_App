...
// Vendored from animate-ui (https://animate-ui.com/r/primitives-effects-effect.json).
// Composable entrance effect (fade / slide / zoom / blur) used for the
// dashboard tile and header reveals.
